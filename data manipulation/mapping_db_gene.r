# 190221 - 1st generation for Mito-GTEx project
# This function is for various manipulation of DAVID GO reults.
...
mapping_go_gene = function(
    ...
    if(Term_size>0) go_sub = subset(
        go, Category%in%category & PValue<pval & Pop.Hits<Term_size)
